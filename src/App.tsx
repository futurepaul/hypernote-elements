      ...
      <div className="h-screen p-4 flex flex-col">
        <div className="mb-4 flex items-center justify-between">
          ...
          <PublishButton markdown={markdownStates[template]} />
            ...
            <Link className="underline text-blue-600" to="/hn/naddr1qvzqqqr40cpzqrtvswydevzfhrw5ljxnmrpmhy778k5sh2pguncfezks7dry3z3nqy88wumn8ghj7mn0wvhxcmmv9uq32amnwvaz7tmjv4kxz7fwv3sk6atn9e5k7tcpzamhxue69uhhyetvv9ujuurjd9kkzmpwdejhgtcqp9khjttrd35k2mn57yhq0e">
